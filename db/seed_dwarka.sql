...
INSERT INTO cameras (camera_code, display_name, location, heading_degrees, status) VALUES
  ('CAM-01', 'Azad Hind Fauj Marg (north) <- Dwarka Mor', ST_SetSRID(ST_MakePoint(77.035193, 28.607958), 4326), 344, 'active'),
  ...
  ('CAM-04', 'Azad Hind Fauj Marg (north) <- Azad Hind Fauj Marg (south)', ST_SetSRID(ST_MakePoint(77.03827, 28.604448), 4326), 128, 'active'),
  ...
  ('CAM-11', 'Palam Najafgarh Road <- Azad Hind Fauj Marg (south)', ST_SetSRID(ST_MakePoint(77.055936, 28.603482), 4326), 17, 'active'),
  ...
  ('CAM-24', 'KM Chowk <- Sector 11', ST_SetSRID(ST_MakePoint(77.044617, 28.590366), 4326), 217, 'active'),
  ('CAM-25', 'Sector 13/14 corner <- KM Chowk', ST_SetSRID(ST_MakePoint(77.049752, 28.596541), 4326), 217, 'active'),
  ('CAM-26', 'KM Chowk <- Sector 13/14 corner', ST_SetSRID(ST_MakePoint(77.047306, 28.593527), 4326), 37, 'active'),
  ('CAM-27', 'Road 221 junction <- Sector 11', ST_SetSRID(ST_MakePoint(77.049601, 28.582674), 4326), 308, 'active'),
  ('CAM-28', 'Sector 11 <- Road 221 junction', ST_SetSRID(ST_MakePoint(77.042445, 28.58748), 4326), 136, 'active'),
  ...
  ('CAM-35', 'Rd 224 (south) <- Sector 10', ST_SetSRID(ST_MakePoint(77.064894, 28.586803), 4326), 307, 'active'),
  ...
  ('CAM-43', 'Sector 17 <- Rd 224 (south)', ST_SetSRID(ST_MakePoint(77.061877, 28.58191), 4326), 37, 'active'),
  ('CAM-44', 'Rd 224 (south) <- Sector 17', ST_SetSRID(ST_MakePoint(77.065208, 28.585967), 4326), 217, 'active'),
...
VALUES
  ('seed-DL3CAB1234-CAM-01', (SELECT camera_id FROM cameras WHERE camera_code='CAM-01'), (SELECT plate_id FROM plates WHERE normalized_plate='DL3CAB1234'), 'DL3CAB1234', 'DL3CAB1234', 0.96, 0.93, '[]'::jsonb, 'accepted', now() - make_interval(secs => 688), 164, 'car', 'white', 2, 'anpr-v1'),
