...
INSERT INTO cameras (camera_code, display_name, location, heading_degrees, status) VALUES
  ('CAM-01', 'Azad Hind Fauj Marg (north) <- Dwarka Mor', ST_SetSRID(ST_MakePoint(77.035735, 28.606278), 4326), 30, 'active'),
  ('CAM-02', 'Dwarka Mor <- Azad Hind Fauj Marg (north)', ST_SetSRID(ST_MakePoint(77.031593, 28.618868), 4326), 168, 'active'),
  ('CAM-03', 'Azad Hind Fauj Marg (south) <- Azad Hind Fauj Marg (north)', ST_SetSRID(ST_MakePoint(77.042091, 28.601973), 4326), 304, 'active'),
  ('CAM-04', 'Azad Hind Fauj Marg (north) <- Azad Hind Fauj Marg (south)', ST_SetSRID(ST_MakePoint(77.035537, 28.606299), 4326), 299, 'active'),
  ('CAM-05', 'Sector 13 (south) <- Azad Hind Fauj Marg (north)', ST_SetSRID(ST_MakePoint(77.034274, 28.592892), 4326), 307, 'active'),
  ('CAM-06', 'Azad Hind Fauj Marg (north) <- Sector 13 (south)', ST_SetSRID(ST_MakePoint(77.035457, 28.606138), 4326), 230, 'active'),
  ('CAM-07', 'Sector 14 / Vegas Mall <- Azad Hind Fauj Marg (north)', ST_SetSRID(ST_MakePoint(77.029382, 28.599561), 4326), 198, 'active'),
  ('CAM-08', 'Azad Hind Fauj Marg (north) <- Sector 14 / Vegas Mall', ST_SetSRID(ST_MakePoint(77.035457, 28.606138), 4326), 230, 'active'),
  ('CAM-09', 'Sector 13 (north) <- Azad Hind Fauj Marg (south)', ST_SetSRID(ST_MakePoint(77.036327, 28.595366), 4326), 258, 'active'),
  ('CAM-10', 'Azad Hind Fauj Marg (south) <- Sector 13 (north)', ST_SetSRID(ST_MakePoint(77.042361, 28.601951), 4326), 37, 'active'),
  ('CAM-11', 'Palam Najafgarh Road <- Azad Hind Fauj Marg (south)', ST_SetSRID(ST_MakePoint(77.055835, 28.603364), 4326), 114, 'active'),
  ...
  ('CAM-14', 'Sector 13 (north) <- Sector 13 (south)', ST_SetSRID(ST_MakePoint(77.03668, 28.595276), 4326), 103, 'active'),
  ('CAM-15', 'Sector 14 / Vegas Mall <- Sector 13 (north)', ST_SetSRID(ST_MakePoint(77.029382, 28.599561), 4326), 198, 'active'),
  ('CAM-16', 'Sector 13 (north) <- Sector 14 / Vegas Mall', ST_SetSRID(ST_MakePoint(77.03668, 28.595276), 4326), 103, 'active'),
  ('CAM-17', 'Sector 11 <- Sector 13 (north)', ST_SetSRID(ST_MakePoint(77.042316, 28.587715), 4326), 336, 'active'),
  ('CAM-18', 'Sector 13 (north) <- Sector 11', ST_SetSRID(ST_MakePoint(77.03668, 28.595276), 4326), 103, 'active'),
  ('CAM-19', 'Sector 14 / Vegas Mall <- Sector 13 (south)', ST_SetSRID(ST_MakePoint(77.029382, 28.599561), 4326), 198, 'active'),
  ('CAM-20', 'Sector 13 (south) <- Sector 14 / Vegas Mall', ST_SetSRID(ST_MakePoint(77.034485, 28.592626), 4326), 131, 'active'),
  ('CAM-21', 'Sector 11 <- Sector 13 (south)', ST_SetSRID(ST_MakePoint(77.042316, 28.587715), 4326), 336, 'active'),
  ('CAM-22', 'Sector 13 (south) <- Sector 11', ST_SetSRID(ST_MakePoint(77.034508, 28.592626), 4326), 126, 'active'),
  ('CAM-23', 'Sector 11 <- KM Chowk', ST_SetSRID(ST_MakePoint(77.04248, 28.587681), 4326), 38, 'active'),
  ('CAM-24', 'KM Chowk <- Sector 11', ST_SetSRID(ST_MakePoint(77.04617, 28.59222), 4326), 1, 'active'),
  ('CAM-25', 'Sector 13/14 corner <- KM Chowk', ST_SetSRID(ST_MakePoint(77.049777, 28.59657), 4326), 218, 'active'),
  ('CAM-26', 'KM Chowk <- Sector 13/14 corner', ST_SetSRID(ST_MakePoint(77.04617, 28.59222), 4326), 1, 'active'),
  ('CAM-27', 'Road 221 junction <- Sector 11', ST_SetSRID(ST_MakePoint(77.049836, 28.582477), 4326), 239, 'active'),
  ('CAM-28', 'Sector 11 <- Road 221 junction', ST_SetSRID(ST_MakePoint(77.042205, 28.58764), 4326), 277, 'active'),
  ...
  ('CAM-32', 'Sector 13/14 corner <- Sector 10', ST_SetSRID(ST_MakePoint(77.050056, 28.596589), 4326), 107, 'active'),
  ('CAM-33', 'Nala Road junction <- Palam Najafgarh Road', ST_SetSRID(ST_MakePoint(77.063857, 28.598529), 4326), 37, 'active'),
  ('CAM-34', 'Palam Najafgarh Road <- Nala Road junction', ST_SetSRID(ST_MakePoint(77.055889, 28.603463), 4326), 70, 'active'),
  ('CAM-35', 'Rd 224 (south) <- Sector 10', ST_SetSRID(ST_MakePoint(77.065414, 28.586211), 4326), 163, 'active'),
  ('CAM-36', 'Sector 10 <- Rd 224 (south)', ST_SetSRID(ST_MakePoint(77.057857, 28.591358), 4326), 136, 'active'),
  ('CAM-37', 'Nala Road junction <- Sector 10', ST_SetSRID(ST_MakePoint(77.063857, 28.598529), 4326), 37, 'active'),
  ('CAM-38', 'Sector 10 <- Nala Road junction', ST_SetSRID(ST_MakePoint(77.057635, 28.59143), 4326), 227, 'active'),
  ('CAM-39', 'Road 221 junction <- Sector 10', ST_SetSRID(ST_MakePoint(77.049833, 28.582401), 4326), 217, 'active'),
  ('CAM-40', 'Sector 10 <- Road 221 junction', ST_SetSRID(ST_MakePoint(77.057633, 28.591388), 4326), 217, 'active'),
  ...
  ('CAM-43', 'Sector 17 <- Rd 224 (south)', ST_SetSRID(ST_MakePoint(77.061528, 28.58183), 4326), 249, 'active'),
  ('CAM-44', 'Rd 224 (south) <- Sector 17', ST_SetSRID(ST_MakePoint(77.065551, 28.586264), 4326), 104, 'active'),
  ('CAM-45', 'Rd 224 (north) <- Rd 224 (mid)', ST_SetSRID(ST_MakePoint(77.071605, 28.594512), 4326), 193, 'active'),
  ('CAM-46', 'Rd 224 (mid) <- Rd 224 (north)', ST_SetSRID(ST_MakePoint(77.069374, 28.59089), 4326), 33, 'active'),
  ('CAM-47', 'Nala Road junction <- Rd 224 (north)', ST_SetSRID(ST_MakePoint(77.063857, 28.598529), 4326), 37, 'active'),
  ('CAM-48', 'Rd 224 (north) <- Nala Road junction', ST_SetSRID(ST_MakePoint(77.071771, 28.59481), 4326), 7, 'active'),
  ('CAM-49', 'Road 224 junction <- Sector 17', ST_SetSRID(ST_MakePoint(77.057895, 28.577227), 4326), 37, 'active'),
  ('CAM-50', 'Sector 17 <- Road 224 junction', ST_SetSRID(ST_MakePoint(77.061593, 28.581718), 4326), 191, 'active'),
  ('CAM-51', 'Road 221 junction <- Road 224 junction', ST_SetSRID(ST_MakePoint(77.049833, 28.582401), 4326), 217, 'active'),
  ('CAM-52', 'Road 224 junction <- Road 221 junction', ST_SetSRID(ST_MakePoint(77.05762, 28.577186), 4326), 278, 'active');
...
VALUES
  ('seed-DL3CAB1234-CAM-01', (SELECT camera_id FROM cameras WHERE camera_code='CAM-01'), (SELECT plate_id FROM plates WHERE normalized_plate='DL3CAB1234'), 'DL3CAB1234', 'DL3CAB1234', 0.96, 0.93, '[]'::jsonb, 'accepted', now() - make_interval(secs => 688), 210, 'car', 'white', 2, 'anpr-v1'),
  ('seed-DL3CAB1234-CAM-03', (SELECT camera_id FROM cameras WHERE camera_code='CAM-03'), (SELECT plate_id FROM plates WHERE normalized_plate='DL3CAB1234'), 'DL3CAB1234', 'DL3CAB1234', 0.96, 0.93, '[]'::jsonb, 'accepted', now() - make_interval(secs => 568), 124, 'car', 'white', 2, 'anpr-v1'),
  ('seed-DL3CAB1234-CAM-09', (SELECT camera_id FROM cameras WHERE camera_code='CAM-09'), (SELECT plate_id FROM plates WHERE normalized_plate='DL3CAB1234'), 'DL3CAB1234', 'DL3CAB1234', 0.96, 0.93, '[]'::jsonb, 'accepted', now() - make_interval(secs => 482), 78, 'car', 'white', 2, 'anpr-v1'),
  ...
  ('seed-DL3CAB1234-CAM-19', (SELECT camera_id FROM cameras WHERE camera_code='CAM-19'), (SELECT plate_id FROM plates WHERE normalized_plate='DL3CAB1234'), 'DL3CAB1234', 'DL3CAB1234', 0.96, 0.93, '[]'::jsonb, 'accepted', now() - make_interval(secs => 108), 18, 'car', 'white', 2, 'anpr-v1');

INSERT INTO sightings (source_event_id, camera_id, plate_id, raw_plate_text, normalized_plate_candidate, detection_confidence, ocr_confidence, ocr_candidates, validation_status, spotted_at, direction_degrees, vehicle_type, vehicle_color, lane_number, model_version)
VALUES
  ('seed-DL8CAF5678-CAM-01', (SELECT camera_id FROM cameras WHERE camera_code='CAM-01'), (SELECT plate_id FROM plates WHERE normalized_plate='DL8CAF5678'), 'DL8CAF5678', 'DL8CAF5678', 0.93, 0.88, '[]'::jsonb, 'accepted', now() - make_interval(secs => 600), 210, 'car', 'black', 3, 'anpr-v1'),
