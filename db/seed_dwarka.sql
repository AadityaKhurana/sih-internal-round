...
INSERT INTO cameras (camera_code, display_name, location, heading_degrees, status) VALUES
  ...
  ('CAM-24', 'KM Chowk <- Sector 11', ST_SetSRID(ST_MakePoint(77.045997, 28.591986), 4326), 217, 'active'),
  ('CAM-25', 'Sector 13/14 corner <- KM Chowk', ST_SetSRID(ST_MakePoint(77.049752, 28.596541), 4326), 217, 'active'),
  ('CAM-26', 'KM Chowk <- Sector 13/14 corner', ST_SetSRID(ST_MakePoint(77.04621, 28.592251), 4326), 37, 'active'),
  ('CAM-27', 'Road 221 junction <- Sector 11', ST_SetSRID(ST_MakePoint(77.049829, 28.582518), 4326), 308, 'active'),
  ('CAM-28', 'Sector 11 <- Road 221 junction', ST_SetSRID(ST_MakePoint(77.042449, 28.587476), 4326), 137, 'active'),
  ...
  ('CAM-35', 'Rd 224 (south) <- Sector 10', ST_SetSRID(ST_MakePoint(77.065331, 28.586514), 4326), 307, 'active'),
  ...
  ('CAM-43', 'Sector 17 <- Rd 224 (south)', ST_SetSRID(ST_MakePoint(77.061856, 28.581886), 4326), 37, 'active'),
  ('CAM-44', 'Rd 224 (south) <- Sector 17', ST_SetSRID(ST_MakePoint(77.065427, 28.586221), 4326), 217, 'active'),
